  ...
  main.variable(observer("vl")).define("vl", ["require"], async function(require)
{
  ...
  const options = {
    ...
    view: {
      ...
      loader: vega.loader({baseURL: '/va/line-chart/'}),
      renderer: 'canvas'
    }
  };
...
`
  ...
  main.variable(observer("zip_codes")).define("zip_codes", ["md"], function(md){return(
md`## Zip Codes
...
vl.markSquare({size: 2, opacity: 1})
  ...
  main.variable(observer("interactive_weather")).define("interactive_weather", ["md"], function(md){return(
  ...
  main.variable(observer()).define(["vl","width"], function(vl,width)
{
  ...
  main.variable(observer("parallel_coordinats")).define("parallel_coordinats", ["md"], function(md){return(
  ...
  main.variable(observer()).define(["vl","width"], function(vl,width)
{
  ...
  main.variable(observer("standalone_use")).define("standalone_use", ["md"], function(md){return(
md`<hr/>
